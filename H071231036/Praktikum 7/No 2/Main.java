...
class Organisasi {
    ...
    public Organisasi(String jenisOrganisasi) {
    ...
    public void tampilkanJenisOrganisasi() {
...
class Keluarga {
    ...
    public Keluarga(boolean menikah) {
...
public class Main {
    ...
    private static void tambahKaryawan() {
        ...
        System.out.println("1. Organisasi sekolah");
        System.out.println("2. Organisasi kampus");
        System.out.println("3. Organisasi kerja");
        System.out.println("4. Tidak ada");
        int organisasi = 0;
        while (true) {
            System.out.print("Input: ");
        ...
        String menikahInput = scanner.nextLine();
        boolean menikah = menikahInput.equalsIgnoreCase("ya");
        ...
        // Tambahkan cek status menikah
        Keluarga keluarga = new Keluarga(menikah);
        keluarga.cekStatusMenikah();
    }
    ...
    private static void playSound(String soundType) {
        String soundFile = "";
        if (soundType.equals("success")) {
            soundFile = "success.wav";
        } else if (soundType.equals("error")) {
            soundFile = "error.wav";
        }
        try {
