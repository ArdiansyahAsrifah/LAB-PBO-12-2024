...
public class TP3_2_H071231054 {
    String name;
    double speed, cash;
    int winningAmount;

    // TODO 1: Create a constructor according to your needs in Main.java
    public TP3_2_H071231054(String name, double speed, double cash) {
        this.name = name;
        this.speed = speed;
        this.cash = cash;
    }

    public TP3_2_H071231054() {
    ...
    public void raceTo(TP3_2_H071231054 enemy) {
    ...
    public static void main(String[] args) {
        TP3_2_H071231054 car1 = new TP3_2_H071231054("Lightning McQueen", 150, 100000);
        TP3_2_H071231054 car2 = new TP3_2_H071231054("Jackson Storm", 155, 120000);
